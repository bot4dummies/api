...
<html lang="en">
<head>
    <title>Code coverage report for lib/api/loaders/database.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">lib/api/loaders</a> database.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (loader === undefined) {
<span class="cstat-no" title="statement not covered" >            throw new Error(0, 'E_LOADER_NOT_FOUND', 'Loader not found');</span>
        }
&nbsp;
...
&nbsp;
        ...
        for (let model in models) {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (models[model].prototype instanceof loader.modelClass()) {
