...
<html lang="en">
<head>
    <title>Code coverage report for lib/api/loaders/components.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">lib/api/loaders</a> components.js
    </h1>
    <div class='clearfix'>
...
exports.fetch = function (instance, component) {
    for (let key in component) {
        ...
        } else <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof component[key] === 'object') {
